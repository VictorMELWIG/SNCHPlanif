...
CREATE TABLE `itineraire` (
  ...
  `ville_depart` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL,
  `ville_arrivee` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL,
  `duree_prevue_min` int NOT NULL,
...
INSERT INTO `itineraire` (`id_itineraire`, `ville_depart`, `ville_arrivee`, `duree_prevue_min`) VALUES (3,'Paris','Lyon',111),(5,'Paris','Brest',10),(6,'Grenoble','Woippy',111),(8,'Marseille','Paris',111),(9,'Poissy','Massy',30),(10,'Lille','Poissy',51646),(11,'zsrgsg','gdgs',567);
...
INSERT INTO `trajet` (`id_trajet`, `date_depart`, `heure_depart`, `heure_arrivee_prevue`, `id_train`, `id_itineraire`, `id_arret_depart`, `id_arret_arrive`) VALUES (3,'2026-02-27','10:03:00','11:54:00',3,3,0,0),(4,'2026-03-07','07:00:00','10:00:00',3,8,0,0);
...
CREATE TABLE `utilisateur` (
  ...
  `role` enum('AGENT','PLANIFICATEUR','ADMIN') COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `utilisateur` (`id_utilisateur`, `login`, `mot_de_passe`, `nom`, `prenom`, `role`, `actif`, `created_at`) VALUES (1,'agent1','1234','Durand','Alice','AGENT',1,'2026-02-05 18:08:29'),(2,'planif1','1234','Martin','Lucas','PLANIFICATEUR',1,'2026-02-05 18:08:29'),(3,'admin1','1234','Admin','SNCH','ADMIN',1,'2026-02-05 19:32:02');
...
-- Dump completed on 2026-04-01 14:30:01
